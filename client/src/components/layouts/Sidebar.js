            ...
            <ul className='nav nav-main'>
              ...
              <li className='nav-parent nav-expanded nav-active'>
                ...
                <ul className='nav nav-children'>
                  ...
                  <li className='nav-parent'>
                    <a href='#!'>Horizontal Menu Header</a>
                    <ul className='nav nav-children'>
                      <li>
                  ...
                  <li className='nav-parent'>
                    <a href='#!'>Left Sidebar Big Icons</a>
                    <ul className='nav nav-children'>
                      <li>
                ...
                <ul className='nav nav-children'>
                  ...
                  <li className='nav-parent'>
                    <a className='nav-link' href='#!'>
                      Icons{' '}
                      <span
                        className='mega-sub-nav-toggle toggled float-right'
                  ...
                  <li className='nav-parent'>
                    <a className='nav-link' href='#!'>
                      Animations{' '}
                      <span
                        className='mega-sub-nav-toggle float-right'
                        data-toggle='collapse'
              ...
              <li>
                <a className='nav-link' href='mailbox-folder.html'>
                  <span className='float-right badge badge-primary'>182</span>
              ...
              <li className='nav-parent'>
                ...
                <ul className='nav nav-children'>
                  <li>
                    <a className='nav-link' href='extra-changelog.html'>
                      Changelog
                    </a>
                  </li>
                  <li>
              ...
              <li className='nav-parent'>
                ...
                <ul className='nav nav-children'>
                  ...
                  <li className='nav-parent'>
                    ...
                    <ul className='nav nav-children'>
                      <li>
                        <a href='#!'>Second Level Link #1</a>
                      </li>
                      <li>
                        <a href='#!'>Second Level Link #2</a>
                      </li>
                      <li className='nav-parent'>
                        <a className='nav-link' href='#!'>
                          Third Level
